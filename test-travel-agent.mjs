...
import { detectTravelIntent, executeTravelTool } from "./lib/travel-intent-router.js";
import { conversationService } from "./lib/conversation-service.js";
import { generationFence } from "./lib/generation-fence.js";
import { interruptController } from "./lib/interrupt-controller.js";
import { measurementPipeline } from "./lib/measurement-pipeline.js";
import { generationAudit } from "./lib/generation-audit.js";
import { delayedToolRegistry } from "./lib/delayed-tool.js";
import { raceDemoController } from "./lib/race-demo-controller.js";
...
async function runSuite() {
  ...
  const cinemaRes = await conversationService.generateResponse("Can you book here cinema ticket?", { delayMs: 10 });
  ...
  assert(finalSnap.staleResults.spokenCount === 0, `Stale spoken strictly 0 (got ${finalSnap.staleResults.spokenCount})`);
